...
from sparse_autoencoder.autoencoder.fista import FISTA
...
@final
class FistaSparseAutoencoder(AbstractAutoencoder):
    ...
    def __init__(
        ...
        self.n_fista_iterations = n_fista_iterations
    ...
    def forward(
        ...
        learned_activations, _ = FISTA(x, self._decoder.weight.data, self.fista_alpha, self.n_fista_iterations, C=learned_activations)
